		  ...
		  <tbody>
		  	<?php
				...
				if (isset($_GET['emp_order']) && isset($_GET['ctc']) && isset($_GET['start']) && isset($_GET['end']) && isset($_GET['search'])) {
					...
					$query = $_GET['search'];
					if ($order == 'name_asc') {
						$sql = "SELECT * FROM `employee_data` WHERE id LIKE '%$query%' OR name LIKE '%$query%' OR department LIKE '%$query%' AND ctc BETWEEN '0' AND '$ctc' ORDER BY `employee_data`.`name` ASC ";
					}else{

						$sql = "SELECT * FROM `employee_data` WHERE id LIKE '%$query%' OR name LIKE '%$query%' OR department LIKE '%$query%' AND ctc BETWEEN '0' AND '$ctc' ORDER BY `employee_data`.`name` DESC ";
					}
